...
const Doctors = () => {
  ...
  const [selectedCategory, setSelectedCategory] =
    useState<DoctorCategory | null>(null);
    ...
    const fetchDoctors = () => {
      const url =
        selectedCategory === null
          ? apiUrl.doctorList
          : `${apiUrl.doctorList}?category_id=${selectedCategory.id}`;
        ...
        {categories.length > 0 ? (
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField
                {...params}
                label={t("doctors.selectCategory")}
                placeholder={t("doctors.searchCategory")}
              />
            )}
            sx={styles.categoryDropdown}
          />
        ) : (
